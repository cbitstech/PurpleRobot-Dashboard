...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CachedAnalysis'
        db.create_table(u'brain_cachedanalysis', (
            ...
            ('analysis', self.gf('django.db.models.fields.TextField')(max_length=1048576)),
        ))
        db.send_create_signal(u'brain', ['CachedAnalysis'])


    def backwards(self, orm):
        # Deleting model 'CachedAnalysis'
        db.delete_table(u'brain_cachedanalysis')
