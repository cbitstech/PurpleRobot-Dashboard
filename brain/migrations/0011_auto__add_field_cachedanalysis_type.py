...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CachedAnalysis.type'
        db.add_column(u'brain_cachedanalysis', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CachedAnalysis.type'
        db.delete_column(u'brain_cachedanalysis', 'type')
