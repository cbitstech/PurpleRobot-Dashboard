...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GeneratedModel'
        db.create_table(u'brain_generatedmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=1048576)),
        ...
        db.send_create_signal(u'brain', ['GeneratedModel'])


    def backwards(self, orm):
        # Deleting model 'GeneratedModel'
        db.delete_table(u'brain_generatedmodel')
