...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReportJob.result_type'
        db.delete_column(u'brain_reportjob', 'result_type')

        # Adding field 'ReportJob.stats_file'
        db.add_column(u'brain_reportjob', 'stats_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReportJob.stats_type'
        db.add_column(u'brain_reportjob', 'stats_type',
                      self.gf('django.db.models.fields.CharField')(default='application/json', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ReportJob.result_type'
        db.add_column(u'brain_reportjob', 'result_type',
                      self.gf('django.db.models.fields.CharField')(default='application/octet-stream', max_length=128),
                      keep_default=False)

        # Deleting field 'ReportJob.stats_file'
        db.delete_column(u'brain_reportjob', 'stats_file')

        # Deleting field 'ReportJob.stats_type'
        db.delete_column(u'brain_reportjob', 'stats_type')
