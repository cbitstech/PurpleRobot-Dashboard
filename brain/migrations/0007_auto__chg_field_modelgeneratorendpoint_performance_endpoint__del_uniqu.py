...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ModelGeneratorEndpoint', fields ['performance_endpoint']
        db.delete_unique(u'brain_modelgeneratorendpoint', ['performance_endpoint_id'])


        # Changing field 'ModelGeneratorEndpoint.performance_endpoint'
        db.alter_column(u'brain_modelgeneratorendpoint', 'performance_endpoint_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['brain.PerformanceMeasurementEndpoint']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ModelGeneratorEndpoint.performance_endpoint'
        raise RuntimeError("Cannot reverse this migration. 'ModelGeneratorEndpoint.performance_endpoint' and its values cannot be restored.")
        # Adding unique constraint on 'ModelGeneratorEndpoint', fields ['performance_endpoint']
        db.create_unique(u'brain_modelgeneratorendpoint', ['performance_endpoint_id'])
