...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportJob.app_key'
        db.add_column(u'brain_reportjob', 'app_key',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportJob.app_key'
        db.delete_column(u'brain_reportjob', 'app_key')
    ...
    models = {
        ...
        u'brain.reportjob': {
            ...
            'app_key': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
