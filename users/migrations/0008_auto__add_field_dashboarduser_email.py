...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DashboardUser.email'
        db.add_column(u'users_dashboarduser', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', unique=True, max_length=512),
                      keep_default=False)
