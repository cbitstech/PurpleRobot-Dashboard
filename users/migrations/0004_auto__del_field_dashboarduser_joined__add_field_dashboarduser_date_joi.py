...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DashboardUser.joined'
        raise RuntimeError("Cannot reverse this migration. 'DashboardUser.joined' and its values cannot be restored.")
