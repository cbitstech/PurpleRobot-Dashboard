...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.error_location'
        db.add_column(u'events_event', 'error_location',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.error_location'
        db.delete_column(u'events_event', 'error_location')
    ...
    models = {
        u'events.event': {
            ...
            'error_location': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'error_type': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '512', 'null': 'True', 'blank': 'True'}),
