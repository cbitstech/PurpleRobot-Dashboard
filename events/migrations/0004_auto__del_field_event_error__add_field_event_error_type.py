...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.error_type'
        db.add_column(u'events_event', 'error_type',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'events_event', 'error',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=512, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'Event.error_type'
        db.delete_column(u'events_event', 'error_type')
