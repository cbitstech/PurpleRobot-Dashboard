...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.properties'
        db.alter_column(u'events_event', 'properties', self.gf('django.db.models.fields.TextField')(max_length=1048576, null=True))

    def backwards(self, orm):

        # Changing field 'Event.properties'
        db.alter_column(u'events_event', 'properties', self.gf('django.db.models.fields.TextField')(max_length=16384, null=True))
